...
def _setup_profile() -> dict:
    ...
    # -- Browser session --
    console.print("\n[bold cyan]Browser Session[/bold cyan]")
    profile["browser"] = {
        "chrome_account_email": Prompt.ask(
            "Chrome account email for auto-apply",
    ...
    # -- Mobility --
    console.print("\n[bold cyan]Mobility[/bold cyan]")
    profile["mobility"] = {
        "willing_to_relocate": Confirm.ask("Are you willing to relocate for a suitable role?", default=False),
    }
